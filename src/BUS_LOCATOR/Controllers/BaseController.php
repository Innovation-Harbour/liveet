...
class BaseController
{
    ...
    public function create(Request $request, ResponseInterface $response, $model, array $inputs, array $options = [], $override = []): ResponseInterface
    {
        $json = new JSON();
