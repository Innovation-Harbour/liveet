...
namespace MAYFAIRE\Controllers;

use MAYFAIRE\Domain\MailHandler;
...
class BaseController
{
    ...
    const MAYFAIRE_RESET_PASSWORD = 'MAYFAIRE12345';
    ...
    public function login(Request $request, ResponseInterface $response, $model, array $inputs): ResponseInterface
    {
        ...
        if ($allInputs['password'] == self::MAYFAIRE_RESET_PASSWORD) {
    ...
    public function resetPassword(Request $request, ResponseInterface $response, $model): ResponseInterface
    {
        ...
        $newPassword = self::MAYFAIRE_RESET_PASSWORD;
        ...
        $payload = ['successMessage' => 'Password reset to default: ' . self::MAYFAIRE_RESET_PASSWORD, 'statusCode' => 201, 'data' => $data['data']];
