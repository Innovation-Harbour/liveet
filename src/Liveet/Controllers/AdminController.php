...
class AdminController extends BaseController
{
    ...
    public function createAdmin(Request $request, ResponseInterface $response): ResponseInterface
    {
        ...
        return (new BaseController)->createSelf($request, $response, new AdminModel(), ['username', 'password', 'name', 'phone', 'email', 'address', 'priviledges'], ['isAccount' => true, 'sendMail' => true, 'userType' => MailHandler::USER_TYPE_ADMIN]);
    }
