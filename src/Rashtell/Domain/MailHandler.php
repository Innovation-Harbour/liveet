...
class MailHandler
{
    ...
    const USER_TYPE_VENDOR = "users";

    public $from = "info@lamatabuswifi.com";
    public $fromName = "LamataBusWifi";
    private $template = "";
    private  $usertype = "";
    private $to = "";
    private $params = "";
                    ...
                    <html lang='en'>
                        ...
                        <body>
                            <div style='width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;'>
                                ...
                                <div align='center'>
                                    <p>
                                        Please confirm your lamatabuswifi account by clicking the link below.
                                    </p>
    ...
    private function getTemplate()
    {
        ...
        switch ($this->template) {
            case self::TEMPLATE_CONFIRM_EMAIL:
                ...
                $link = "https://" . $_ENV["PRODUCTION_HOST"] . $_ENV["BASE_PATH"] . "/" . $this->usertype . "/update/verify/email/" . $this->params["emailVerificationToken"];
            ...
            case self::TEMPLATE_FORGOT_PASSWORD:
                ...
                $link = "https://" . $_ENV["PRODUCTION_HOST"] . $_ENV["BASE_PATH"] . "/" . $this->usertype . "/forgot/password/" . $this->params["forgotPasswordToken"];
